...
public class Constants {
    ...
    public static final String win = " did a good job and I admit my lose. I will give an A to ";
    public static final String lose = "did a terrible job on this game, go back and play again! ";
}
